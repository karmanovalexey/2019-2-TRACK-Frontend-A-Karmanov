...
template.innerHTML = `
  <style>
    ...
    .back:focus, .back:hover .back-icon{
    ...
    .search:focus, .search:hover .search-icon{
      fill: rgb(255, 255, 255);
      transition: 0.2s;
    }
    ...
    .more:focus, .more:hover .more-icon{
      fill: rgb(255, 255, 255);
      transition: 0.2s;
    }
  ...
  <div class = "top-line">
    <button class = "back">
      <svg class="back-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <div class="interlocutor">
            <svg class="interlocutor-icon" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
    ...
    <button class="more">
            <svg class="more-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
